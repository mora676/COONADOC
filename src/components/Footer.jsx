      ...
      <div className="footer__container">
        ...
        <div className="footer__section">
          ...
          <ul className="footer__list">
            ...
            <li className="footer__item">
              <Link to="/Home/quienes-somos" className="footer__link">Quiénes Somos</Link>
            </li>
            <li className="footer__item">
              <Link to="/Home/afiliacion-servicios" className="footer__link">Afiliación y Servicios</Link>
            </li>
            <li className="footer__item">
              <Link to="/Home/documentacion" className="footer__link">Documentación</Link>
            </li>
          </ul>
        </div>
